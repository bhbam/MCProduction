...
process.Realistic25ns13TeVEarly2018CollisionVtxSmearingParameters = cms.PSet(
    Alpha = cms.double(0.0),
    BetaStar = cms.double(30.0),
    Emittance = cms.double(1.634e-08),
    Phi = cms.double(0.0),
    SigmaZ = cms.double(3.5),
    TimeOffset = cms.double(0.0),
...
process.RealisticPbPbCollision2018VtxSmearingParameters = cms.PSet(
    Alpha = cms.double(0.0),
...
process.Run3FlatOpticsGaussVtxSigmaZ4p2cmSmearingParameters = cms.PSet(
...
process.Run3FlatOpticsGaussVtxSigmaZ5p3cmSmearingParameters = cms.PSet(
    MeanX = cms.double(0.0107682),
    MeanY = cms.double(0.041722),
    MeanZ = cms.double(0.035748),
    SigmaX = cms.double(0.0015),
...
process.Run3RoundOptics25ns13TeVHighSigmaZVtxSmearingParameters = cms.PSet(
    Alpha = cms.double(0.0),
    BetaStar = cms.double(28.0),
    Emittance = cms.double(4.762e-08),
    Phi = cms.double(0.0),
...
process.Run3RoundOptics25ns13TeVLowSigmaZVtxSmearingParameters = cms.PSet(
    Alpha = cms.double(0.0),
    BetaStar = cms.double(28.0),
    Emittance = cms.double(4.762e-08),
    Phi = cms.double(0.0),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    eventAutoFlushCompressedSize = cms.untracked.int32(20971520),
    fileName = cms.untracked.string('file:GEN_HToAAToTauTau_M10_2018UL.root'),
    outputCommands = cms.untracked.vstring(
        'drop *', 
        'drop *', 
        'keep  FEDRawDataCollection_rawDataCollector_*_*', 
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('102X_upgrade2018_realistic_v4'),
...
process.pgen = cms.Sequence(process.randomEngineStateProducer+process.VertexSmearing+process.GenSmeared+process.GeneInfo+process.genJetMET)
...
process.generation_step = cms.Path(process.generator+process.genHToAATo4TauFilter, cms.Task(process.VtxSmeared, process.generatorSmeared, process.randomEngineStateProducer), cms.Task(process.ak4GenJets, process.ak4GenJetsNoNu, process.ak8GenJets, process.ak8GenJetsNoNu, process.genCandidatesForMET, process.genMetCalo, process.genMetTrue, process.genParticles, process.genParticlesForJets, process.genParticlesForJetsNoNu, process.genParticlesForMETAllVisible))


process.RAWSIMoutput_step = cms.EndPath(process.RAWSIMoutput)


process.genfiltersummary_step = cms.EndPath(process.genXSecAnalyzer, cms.Task(process.genFilterEfficiencyProducer))
...
process.schedule = cms.Schedule(*[ process.generation_step, process.genfiltersummary_step, process.endjob_step, process.RAWSIMoutput_step ], tasks=[process.patAlgosToolsTask])
