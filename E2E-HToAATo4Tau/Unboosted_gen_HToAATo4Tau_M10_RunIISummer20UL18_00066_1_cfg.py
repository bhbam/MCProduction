...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:Unboosted_GEN_HToAAToTauTau_M8_2018UL.root'), # uncomment when crab submission
...
process.genHToAATo4TauFilter = cms.EDFilter("GenHToAATo4TauFilter",
   ...
   taudRCut  = cms.double(0.6)   #GenTauTau dR max value for merged taus
