...
config.General.requestName     = 'aToTauTau_Hadronic_tauDR0p4_m1p2To3p6_pythia8_DIGI_RECO_unphysical'
...
# config.Data.userInputFiles = open('list_one.txt').readlines()
# config.Data.userInputFiles = open('list_aToTauTau_Hadronic_tauDR0p4_m3p6To16_pythia8_DIGI_RECO.txt').readlines()
# config.Data.userInputFiles = open('list_unphysical_gen_test.txt').readlines()
