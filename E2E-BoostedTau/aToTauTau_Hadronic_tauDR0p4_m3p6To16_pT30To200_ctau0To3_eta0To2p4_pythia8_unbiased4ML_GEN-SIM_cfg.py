...
process.genAToTauTauFilter = cms.EDFilter("GenAToTauTauFilter",
    ...
    ,a_mass_min  = cms.double(3.6),             #A min mass
    a_mass_max  = cms.double(18),              #A max mass
    a_pt_min  = cms.double(30.0),              #A pt min
    a_pt_max  = cms.double(200.0),             #A pt max
    mass_bins  = cms.double(37),               #mass bins (3.6-18 with 0.4 --> 37)
    pt_bins  = cms.double(35),                 #pt bins (30-200 with 5 --> 35)
    n_Events  = cms.double(50)                  #Max number of events allowed in bins
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:aToTauTau_GEN.root'),
