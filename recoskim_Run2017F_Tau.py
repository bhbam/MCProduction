...
# with command line options: RECO -s RAW2DIGI,L1Reco,RECO --runUnscheduled --nThreads 8 --data --era Run2_2017 --scenario pp --conditions 94X_dataRun2_ReReco_EOY17_v6 --eventcontent AOD --datatier AOD --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2017 --filein file:pippo.root -n 100 --python_filename=recoskim_Run2017F_Tau.py --no_exec
